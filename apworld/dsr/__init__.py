...
class DSRWorld(World):
    ...
    def create_regions(self):
        ...
        our_regions = [
            ...
            "Northern Undead Asylum - Raven Nest",
            "Firelink Shrine",
            "Upper Undead Burg - Before Fog",
            "Upper Undead Burg - Fog Gate Front",
            "Upper Undead Burg - Fog Gate Back",
            "Upper Undead Burg", 
            "Upper Undead Burg - Pine Resin Chest",
            "Upper Undead Burg - Taurus Demon Entrance Fog Gate Front",
            "Upper Undead Burg - Taurus Demon Entrance Fog Gate Back",
            "Upper Undead Burg - Taurus Demon",
            "Upper Undead Burg - Taurus Demon Exit Fog Gate Front",
            "Upper Undead Burg - Taurus Demon Exit Fog Gate Back",
            "Upper Undead Burg - Hellkite Bridge",
            "Undead Parish - Before Fog", 
            "Undead Parish - Fog Gate Front",
            "Undead Parish - Fog Gate Back",
            "Undead Parish",
            "Undead Parish - Bell Gargoyles Entrance Fog Gate Front",
            "Undead Parish - Bell Gargoyles Entrance Fog Gate Back",
            "Undead Parish - Bell Gargoyles",
            "Undead Parish - Bell Gargoyles Exit Fog Gate Front",
            "Undead Parish - Bell Gargoyles Exit Fog Gate Back",
            "Firelink Shrine - After Undead Parish Elevator",
            "Firelink Shrine - Raven Nest",
            ...
            "Lower Undead Burg - Capra Demon Fog Gate Front",
            "Lower Undead Burg - Capra Demon Fog Gate Back",
            "Lower Undead Burg - Capra Demon",
            "Lower Undead Burg - After Capra Demon",
            "Watchtower Basement",
            "Depths", 
            "Depths - Fog Gate Front",
            "Depths - Fog Gate Back",
            "Depths - After Sewer Chamber Key",
            "Depths - Gaping Dragon Fog Gate Front",
            "Depths - Gaping Dragon Fog Gate Back",
            ...
            "Lower Blighttown - Fog Gate Front",
            "Lower Blighttown - Fog Gate Back",
            "Lower Blighttown",
            "Lower Blighttown - Quelaag Entrance Fog Gate Front",
            "Lower Blighttown - Quelaag Entrance Fog Gate Back",
            "Lower Blighttown - Quelaag",
            "Lower Blighttown - Quelaag Exit Fog Gate Front",
            "Lower Blighttown - Quelaag Exit Fog Gate Back",
            ...
            "Darkroot Garden - Fog Gate Front",
            "Darkroot Garden - Fog Gate Back",
            "Darkroot Garden",
            "Darkroot Garden - Sif Entrance Front",
            "Darkroot Garden - Sif",
            "Darkroot Garden - Sif Entrance Back",            
            "Darkroot Garden - Behind Artorias Door",
            "Darkroot Garden - Moonlight Butterfly Entrance Fog Gate Front",
            "Darkroot Garden - Moonlight Butterfly Entrance Fog Gate Back",
            "Darkroot Garden - Moonlight Butterfly",
            "Darkroot Garden - Moonlight Butterfly Exit Fog Gate Front",
            "Darkroot Garden - Moonlight Butterfly Exit Fog Gate Back",
            "Darkroot Garden - After Moonlight Butterfly",
            "The Great Hollow",
            "Ash Lake - Fog Gate Front",
            "Ash Lake - Fog Gate Back",
            "Ash Lake",
            "Sen's Fortress",
            "Sen's Fortress - First Fog Gate Front",
            "Sen's Fortress - First Fog Gate Back",
            "Sen's Fortress - After First Fog",
            "Sen's Fortress - Second Fog Gate Front",
            "Sen's Fortress - Second Fog Gate Back",
            "Sen's Fortress - After Second Fog",
            "Sen's Fortress - After Cage Key",
            "Sen's Fortress - Iron Golem Fog Gate Front",
            "Sen's Fortress - Iron Golem Fog Gate Back",
            "Sen's Fortress - Iron Golem",
            "Sen's Fortress - Demon Flight",
            "Sen's Fortress - After Iron Golem",
            "Anor Londo - Demon Flight",
            "Anor Londo",
            "Anor Londo - First Fog Gate Front",
            "Anor Londo - First Fog Gate Back",
            "Anor Londo - After First Fog",
            "Anor Londo - Painting Room",
            "Anor Londo - Second Fog Gate Front",
            "Anor Londo - Second Fog Gate Back",
            "Anor Londo - After Second Fog",
            "Anor Londo - Ornstein and Smough Fog Gate Front",
            "Anor Londo - Ornstein and Smough Fog Gate Back",
            "Anor Londo - Ornstein and Smough",
            "Anor Londo - Ornstein Fog Gate Front",
            "Anor Londo - Ornstein Fog Gate Back",
            "Anor Londo - Smough Fog Gate Front",
            "Anor Londo - Smough Fog Gate Back",
            "Anor Londo - After Ornstein and Smough",
            "Anor Londo - Gwyndolin Fog Gate Front",
            "Anor Londo - Gwyndolin Fog Gate Back",
            "Anor Londo - Gwyndolin",
            "Anor Londo - After Gwyndolin",
            "Painted World of Ariamis",
            "Painted World of Ariamis - Fog Gate Front",
            "Painted World of Ariamis - Fog Gate Back",
            "Painted World of Ariamis - After Fog",
            "Painted World of Ariamis - After Annex Key",
            "Painted World of Ariamis - Crossbreed Priscilla Fog Gate Front",
            "Painted World of Ariamis - Crossbreed Priscilla Fog Gate Back",
            "Painted World of Ariamis - Crossbreed Priscilla",
            "Upper New Londo Ruins",
            "Upper New Londo Ruins - Fog Gate Front",
            "Upper New Londo Ruins - Fog Gate Back",
            "Upper New Londo Ruins - After Fog",
            "New Londo Ruins Door to the Seal",
            "Lower New Londo Ruins", 
            "Four Kings - Fog Gate Front",
            "Four Kings - Fog Gate Back",
            "The Abyss", 
            "The Abyss - After Four Kings", 
            "The Duke's Archives", 
            "The Duke's Archives - Seath Fog Gate Front",
            "The Duke's Archives - Seath Fog Gate Back",
            ...
            "The Duke's Archives - Courtyard Fog Gate Front",
            "The Duke's Archives - Courtyard Fog Gate Back",
            "The Duke's Archives - Courtyard",
            "The Duke's Archives - Giant Cell", 
            "Crystal Cave",
            "Crystal Cave - Seath Fog Gate Front",
            "Crystal Cave - Seath Fog Gate Back",
            "Crystal Cave - After Seath", 
            "The Duke's Archives - First Arena after Seath's Death", 
            "Demon Ruins - Early",
            "Demon Ruins - Ceaseless Discharge Fog Gate Front",
            "Demon Ruins - Ceaseless Discharge Fog Gate Back",
            "Demon Ruins - Ceaseless Discharge",
            "Demon Ruins",
            "Demon Ruins - Demon Firesage Entrance Fog Gate Front",
            "Demon Ruins - Demon Firesage Entrance Fog Gate Back",
            "Demon Ruins - Demon Firesage",
            "Demon Ruins - Demon Firesage Exit Fog Gate Front",
            "Demon Ruins - Demon Firesage Exit Fog Gate Back",
            "Demon Ruins - After Demon Firesage",
            "Demon Ruins - Centipede Demon Entrance Fog Gate Front",
            "Demon Ruins - Centipede Demon Entrance Fog Gate Back",
            "Demon Ruins - Centipede Demon",
            "Demon Ruins - Centipede Demon Exit Fog Gate Front",
            "Demon Ruins - Centipede Demon Exit Fog Gate Back",
            "Demon Ruins Shortcut",
            "Lost Izalith",
            "Lost Izalith - Bed of Chaos Fog Gate Front",
            "Lost Izalith - Bed of Chaos Fog Gate Back",
            "Lost Izalith - Bed of Chaos", 
            "The Catacombs",
            "The Catacombs - Door 1",
            "The Catacombs - After Door 1",
            "The Catacombs - Coffin To Nito",
            "The Catacombs - Pinwheel Fog Gate Front",
            "The Catacombs - Pinwheel Fog Gate Back",
            "The Catacombs - Pinwheel",
            "The Catacombs - After Pinwheel",
            "Tomb of the Giants", 
            "Tomb of the Giants - Fog Gate Front",
            "Tomb of the Giants - Fog Gate Back",
            "Tomb of the Giants - After White Fog", 
            "Tomb of the Giants - Behind Golden Fog Wall",
            "Tomb of the Giants - Nito Fog Gate Front",
            "Tomb of the Giants - Nito Fog Gate Back",
            "Tomb of the Giants - Nito",
            "Tomb of the Giants - After Nito",
            "Firelink Altar",
            "Kiln of the First Flame",
            "Kiln of the First Flame - Gwyn Fog Gate Front",
            "Kiln of the First Flame - Gwyn Fog Gate Back",
            "Kiln of the First Flame - Gwyn",
            "Sanctuary Garden", 
            "Sanctuary Garden - Sanctuary Guardian Entrance Fog Gate Front",
            "Sanctuary Garden - Sanctuary Guardian Entrance Fog Gate Back",
            "Sanctuary Garden - Sanctuary Guardian",
            "Sanctuary Garden - Sanctuary Guardian Exit Fog Gate Front",
            "Sanctuary Garden - Sanctuary Guardian Exit Fog Gate Back",
            "Oolacile Sanctuary", 
            "Royal Wood",
            "Royal Wood - Artorias Entrance Fog Gate Front",
            "Royal Wood - Artorias Entrance Fog Gate Back",
            "Royal Wood - Artorias",
            "Royal Wood - Artorias Exit Fog Gate Front",
            "Royal Wood - Artorias Exit Fog Gate Back",
            "Royal Wood - After Hawkeye Gough",
            "Kalameet - Fog Gate Front",
            "Kalameet - Fog Gate Back",
            "Royal Wood - PvP Colloseum Fog Gate Front",
            "Royal Wood - PvP Colloseum Fog Gate Back",
            "Oolacile Township", 
            "Oolacile Township - Behind Light-Dispelled Walls",
            "Oolacile Township - After Crest Key",
            "Chasm of the Abyss",
            "Chasm of the Abyss - Manus Fog Gate Front",
            "Chasm of the Abyss - Manus Fog Gate Front",
